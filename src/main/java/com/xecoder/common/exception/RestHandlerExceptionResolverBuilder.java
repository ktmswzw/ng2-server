...
import com.xecoder.common.exception.handler.*;
import com.xecoder.common.utils.MapUtils;
...
public class RestHandlerExceptionResolverBuilder {
    ...
    public static final String DEFAULT_MESSAGES_BASENAME = "classpath:messages";
     ...
     * (with {@link #defaultContentType(org.springframework.http.MediaType) defaultContentType}) will be used.
     */
     ...
     * interface, e.g. {@link cz.jirutka.spring.exhandler.handlers.ErrorMessageRestExceptionHandler}. Built-in exception handlers uses
     ...
     * {@link cz.jirutka.spring.exhandler.handlers.ErrorMessageRestExceptionHandler}. Required for built-in exception handlers.
     */
    ...
    /**
     * Same as {@link #addHandler(Class, cz.jirutka.spring.exhandler.handlers.RestExceptionHandler)}, but the exception type is
     * determined from the handler.
     */
    public <E extends Exception>
            RestHandlerExceptionResolverBuilder addHandler(SysAbstractRestExceptionHandler<E, ?> exceptionHandler) {

        return addHandler(exceptionHandler.getExceptionClass(), exceptionHandler);
    }

    /**
     * Registers {@link cz.jirutka.spring.exhandler.handlers.ErrorMessageRestExceptionHandler} for the specified exception type.
    ...
    public RestHandlerExceptionResolverBuilder addErrorMessageHandler(
        ...
        return addHandler(new SysRestExceptionHandler<>(exceptionClass, status));
    }
...
//        }
        ...
        addHandlerTo(map, SysException.class, NOT_ACCEPTABLE);
    ...
    private void addHandlerTo(Map<Class, RestExceptionHandler> map, Class exceptionClass, HttpStatus status) {
        map.put(exceptionClass, new SysRestExceptionHandler(exceptionClass, status));
    }
