...
public class DruidConfiguration {
    ...
    public DataSource druidDataSource(@Value("${spring.datasource.driver-class-name}") String driver,
                                      ...
                                      @Value("${spring.datasource.time-between-eviction-runs-millis}") int betweenEvictionMillis,
                                      @Value("${spring.datasource.min-evictable-idle-time-millis}") int minEvictionMillis,
        ...
        druidDataSource.setTimeBetweenEvictionRunsMillis(betweenEvictionMillis);
        druidDataSource.setMinEvictableIdleTimeMillis(minEvictionMillis);
